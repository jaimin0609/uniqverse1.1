...
- Name: Admin Dashboard >> should display admin dashboard with key metrics
- Location: C:\Users\James\Desktop\uniqverse-v1\e2e\admin-dashboard.spec.ts:19:9
...
============================================================
    at C:\Users\James\Desktop\uniqverse-v1\e2e\admin-dashboard.spec.ts:12:20
```
...
>  12 |         await page.waitForURL('/', { timeout: 10000 });
  ...
  109 |     });
  110 |
  111 |     test('should display pending actions section', async ({ page }) => {
  112 |         // Check for pending orders count
```