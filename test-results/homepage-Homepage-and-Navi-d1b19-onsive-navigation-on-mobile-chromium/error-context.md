...
- Name: Homepage and Navigation >> should have responsive navigation on mobile
- Location: C:\Users\James\Desktop\uniqverse-v1\e2e\homepage.spec.ts:103:13
...
Call log:
  - waiting for locator('button:has(svg[class*="lucide-menu"]), button[aria-label*="menu" i]')
    - locator resolved to <button aria-label="Open menu" class="p-2 rounded-md text-slate-600 dark:text-slate-300 hover:text-primary focus:outline-none">…</button>
  - attempting click action
    ...
    at C:\Users\James\Desktop\uniqverse-v1\e2e\homepage.spec.ts:112:33
```
