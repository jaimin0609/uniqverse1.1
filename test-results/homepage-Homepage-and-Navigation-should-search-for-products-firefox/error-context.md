...
- Name: Homepage and Navigation >> should search for products
- Location: C:\Users\James\Desktop\uniqverse-v1\e2e\homepage.spec.ts:45:13
...
Call log:
  - waiting for locator('button:has(svg[class*="lucide-search"])')
    - locator resolved to <button aria-label="Search" class="p-2 text-slate-600 dark:text-slate-300 hover:text-primary focus:outline-none">…</button>
  - attempting click action
    ...
    at C:\Users\James\Desktop\uniqverse-v1\e2e\homepage.spec.ts:51:28
```
