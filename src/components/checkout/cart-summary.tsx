                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {items.map((item) => (
                            <tr key={`${item.id}-${item.variantId || 'default'}`}>
                                ...
                                {/* Quantity */}
                                <td className="px-6 py-4 whitespace-nowrap">                                <div className="flex items-center border rounded w-24">
                                    <button
                                    ...
                                    <input
                                        ...
                                        value={item.quantity}
                                        readOnly
                                        className="w-full text-center border-0 focus:ring-0 text-gray-900 font-medium"
