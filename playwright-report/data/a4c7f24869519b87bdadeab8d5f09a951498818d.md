...
- Name: Homepage and Navigation >> should navigate to shop page
- Location: C:\Users\James\Desktop\uniqverse-v1\e2e\homepage.spec.ts:22:13
...
Call log:
  - waiting for locator('nav a[href="/shop"], a[href="/shop"]').first()
    - locator resolved to <a href="/shop" class="text-slate-600 dark:text-slate-300 hover:text-primary px-2 py-1 rounded-md text-sm font-medium ">Shop</a>
  - attempting click action
    ...
    at C:\Users\James\Desktop\uniqverse-v1\e2e\homepage.spec.ts:38:24
```
