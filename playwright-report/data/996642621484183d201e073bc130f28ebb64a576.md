...
- Name: Admin Order Management >> should display orders page with filters and search
- Location: C:\Users\James\Desktop\uniqverse-v1\e2e\admin-orders.spec.ts:17:9
...
Call log:
  ...
  - attempting fill action
    ...
    at C:\Users\James\Desktop\uniqverse-v1\e2e\admin-orders.spec.ts:8:20
```
...
- main:
  ...
  - paragraph:
    ...
    - link "Create an account":
      - /url: /auth/register
  - text: Email address
  - textbox "Email address": admin@uniqverse.com
  - text: Password
  - textbox "Password"
