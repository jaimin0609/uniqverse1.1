...
- Name: Payment Flow E2E >> should handle multiple payment methods
- Location: C:\Users\James\Desktop\uniqverse-v1\e2e\payment-flow.spec.ts:237:9
...
Call log:
  - waiting for locator('a[href*="/products/"]').first()
    ...
    at C:\Users\James\Desktop\uniqverse-v1\e2e\payment-flow.spec.ts:243:28
```
