...
- Name: Homepage and Navigation >> should load homepage successfully
- Location: C:\Users\James\Desktop\uniqverse-v1\e2e\homepage.spec.ts:4:9

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: getByText(/featured/i) resolved to 3 elements:
    1) <a href="/shop/featured" class="block px-4 py-2 text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800">Shop Featured</a> aka getByRole('link', { name: 'Shop Featured' })
    2) <h2 class="text-3xl font-bold">Featured Products</h2> aka getByRole('heading', { name: 'Featured Products' })
    3) <a href="/shop/featured" class="hover:text-white transition-colors">Featured</a> aka getByRole('link', { name: 'Featured', exact: true })

Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText(/featured/i)

    at C:\Users\James\Desktop\uniqverse-v1\e2e\homepage.spec.ts:21:51
```
